...
public void tDIR(boolean DIRFlag){
  if (DIRFlag==true){
  dir=0;
...
public void tMODE(boolean MODEFlag){
  if (MODEFlag==true){
  OV=1;
...
public void EXT(boolean EXTFlag){
  if (EXTFlag==true){
 port.write("E,");
  println ("E");
...
if (mode!=0){
    ...
    if (mode==2){
    msg=msg+OV;}
    msg=msg+PApplet.parseFloat(cp5.get(Textfield.class,"FREQ").getText());
    ...
    pmsg=" ";
    msg=msg+PApplet.parseFloat(cp5.get(Textfield.class,"FREQ").getText()) + "|" + PApplet.parseFloat(cp5.get(Textfield.class,"Start").getText()) + "|" + PApplet.parseFloat(cp5.get(Textfield.class,"End").getText());
    }
  ...
  public void settings() {  size(820, 600); }
